...
public record LocationUpdateRequest(
		@NotNull
		@Schema(description = "수정할 후보지 식별자", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
		Long id,

		@NotNull(message = "사진은 필수 입력사항입니다.")
		@Schema(description = "후보지 사진", example = "http://~.png", requiredMode = Schema.RequiredMode.REQUIRED)
		String image,

		@NotNull(message = "카테고리는 필수 입력사항입니다.")
		@Schema(description = "후보지 카테고리 수정 내용", example = "DRINK", requiredMode = Schema.RequiredMode.REQUIRED)
		Category category,

		@Schema(description = "후보지 설명 수정 내용", example = "바나나맛이 맛있다고함!", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
		String description,
		...
		@Schema(description = "수정한 후보지가 속한 모임 식별자", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
		Long partyId
) {
}
