...
@Schema(name = "공개 루트 댓글 전체 조회 요청 정보")
public record PublicRouteCommentGetAllRequest(
		...
		@NotBlank(message = "조회할 공개 루트 id는 필수 입력값입니다.")
		@Schema(description = "댓글을 조회할 공개 루트", example = "1", required = true)
		Long routeId
) {
}
